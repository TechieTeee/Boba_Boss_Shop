...
function get(res: NextApiResponse<MakeTransactionGetResponse>) {
    res.status(200).json({
        label: "Boba Boss Shop",
        icon: "https://media.giphy.com/media/3b9OHGvLptiuGSGpib/giphy.gif",
    })
}
...
async function post(
    ...
    try {
        ...
        const message = buyerGetsCouponDiscount ? "50% Discount! 😋" : "Thanks for your order! Have a Bobalicious Day! 😋"
